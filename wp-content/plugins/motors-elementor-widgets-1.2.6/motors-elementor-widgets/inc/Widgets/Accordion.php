...
class Accordion extends WidgetBase {
	...
	public function get_title() {
		return esc_html__( 'Accordion', 'motors-elementor-widgets' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'panels',
			array(
				'label'       => esc_html__( 'Accordion Panels', 'motors-elementor-widgets' ),
		...
		$this->stm_ew_add_color(
			'active_icon',
			array(
				'label'     => __( 'Active Icon Color', 'motors-elementor-widgets' ),
				'selectors' => array(
		...
		$this->stm_ew_add_color(
			'active_title',
			array(
				'label'     => __( 'Active Title Color', 'motors-elementor-widgets' ),
				'default'   => '#232628',
				'selectors' => array(
	...
	protected function render() {
		...
		Helper::stm_ew_load_template( 'widgets/accordion', MOTORS_ELEMENTOR_WIDGETS_PATH, $settings );
	}

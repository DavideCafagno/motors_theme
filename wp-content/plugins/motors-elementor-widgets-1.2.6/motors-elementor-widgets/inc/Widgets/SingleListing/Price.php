...
class Price extends WidgetBase {
	...
	public function get_name() {
		return MotorsApp::STM_PREFIX . '-single-listing-price';
	}
	...
	public function get_title() {
		return esc_html__( 'Price', 'motors-elementor-widgets' );
	}
	...
	protected function render() {
		...
		Helper::stm_ew_load_template( 'widgets/single-listing/price', MOTORS_ELEMENTOR_WIDGETS_PATH, $settings );
	}

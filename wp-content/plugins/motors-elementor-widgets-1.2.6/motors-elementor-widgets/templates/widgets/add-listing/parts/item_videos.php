...
if ( $custom_listing_type && $listing_types_options && isset( $listing_types_options[ $custom_listing_type . '_addl_video_content' ] ) ) {
	...
	$content = stm_me_get_wpcfto_mod( 'addl_video_content', '' );
}
...
if ( empty( $_id ) ) :
	...
	<div class="stm-form-4-videos clearfix">
		<div class="stm-car-listing-data-single stm-border-top-unit ">
			<div class="title heading-font"><?php esc_html_e( 'Add Videos', 'motors-elementor-widgets' ); ?></div>
		</div>
					...
					<div class="stm-video-units">
						<div class="stm-video-link-unit-wrap">
							<div class="heading-font">
								<span class="video-label"><?php esc_html_e( 'Video link', 'motors-elementor-widgets' ); ?></span> <span

...
$note = '';
if ( ! empty( $_id ) ) {
	$note = stm_get_listing_seller_note( $_id );
}
...
if ( $custom_listing_type && $listing_types_options && isset( $listing_types_options[ $custom_listing_type . '_addl_seller_note_content' ] ) ) {
	...
	$stm_phrases = stm_me_get_wpcfto_mod( 'addl_seller_note_content', '' );
}
...
<div class="stm-form-5-notes clearfix">
	<div class="stm-car-listing-data-single stm-border-top-unit ">
		<div class="title heading-font"><?php esc_html_e( 'Enter Seller\'s notes', 'motors-elementor-widgets' ); ?></div>
	</div>
				...
				if ( ! empty( $stm_phrases ) ) :
					...
					<div class="stm_phrases">
						<div class="inner">
							...
							<h5><?php esc_html_e( 'Select all the phrases that apply to your vehicle.', 'motors-elementor-widgets' ); ?></h5>
		...
		<?php if ( ! empty( $stm_phrases ) ) : ?>
			<div class="col-md-3 col-sm-3 hidden-xs">
				<div class="stm-seller-notes-phrases heading-font">
					<span><?php esc_html_e( 'Add the Template Phrases', 'motors-elementor-widgets' ); ?></span>
				</div>
			</div>
		<?php endif; ?>
	</div>

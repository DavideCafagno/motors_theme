...
<div class="stm-dealer-info-unit phone">
	<?php echo wp_kses( $dpn_icon, apply_filters( 'stm_ew_kses_svg', array() ) ); ?>
	<div class="inner">
		...
		<?php else : ?>
			...
			<span class="stm-show-number" data-id="<?php echo esc_attr( $user_id ); ?>"><?php echo esc_html( $dpn_show_number ); ?></span>
		<?php endif; ?>
	</div>
</div>

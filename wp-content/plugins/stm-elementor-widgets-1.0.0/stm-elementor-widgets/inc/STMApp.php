...
class STMApp {
	...
	public function __construct() {
		...
		add_action( 'elementor/widgets/widgets_registered', array( self::class, 'stm_ew_register_elementor_widgets' ) );
	...
	public static function stm_ew_enqueue_scripts() {
		...
		if ( ! wp_script_is( 'swiper', 'registered' ) ) {
			wp_enqueue_script( 'swiper', ELEMENTOR_ASSETS_URL . 'lib/swiper/swiper.min.js', array(), STM_ELEMENTOR_WIDGETS_PLUGIN_VERSION, true );
		}
	}
	...
	public static function stm_ew_editor_enqueue_scripts() {
		wp_enqueue_style( 'stm-elementor-icons', STM_ELEMENTOR_WIDGETS_URL . '/assets/icons/style.css', array(), STM_ELEMENTOR_WIDGETS_PLUGIN_VERSION );
		wp_enqueue_style( 'stm-elementor-editor', STM_ELEMENTOR_WIDGETS_URL . '/assets/css/editor.css', array(), STM_ELEMENTOR_WIDGETS_PLUGIN_VERSION );
	}

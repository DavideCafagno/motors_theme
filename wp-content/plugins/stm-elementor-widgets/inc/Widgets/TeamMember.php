...
class TeamMember extends WidgetBase {
	...
	public function get_title() {
		return esc_html__( 'Team Member', 'stm-elementor-widgets' );
	}
	...
	protected function register_controls() {
		...
		$this->stm_ew_add_media(
			'image',
			array(
				'label' => __( 'Photo', 'stm-elementor-widgets' ),
			)
		);
		...
		$this->stm_ew_add_text(
			'image_size',
			array(
				'label'       => __( 'Photo Size', 'stm-elementor-widgets' ),
				'placeholder' => __( '257x170', 'stm-elementor-widgets' ),
				'default'     => '257x170',
				'description' => __( 'Enter photo size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "medium" size.', 'stm-elementor-widgets' ),
			)
		);
		...
		$this->stm_ew_add_text(
			'name',
			array(
				'label'   => __( 'Name', 'stm-elementor-widgets' ),
				'default' => 'John Smith',
			)
		);
		...
		$this->stm_ew_add_text(
			'position',
			array(
				'label'   => __( 'Position', 'stm-elementor-widgets' ),
		...
		$this->stm_ew_add_text(
			'email',
			array(
				'label'   => __( 'Email', 'stm-elementor-widgets' ),
		...
		$this->stm_ew_add_text(
			'phone',
			array(
				'label'   => __( 'Phone', 'stm-elementor-widgets' ),
		...
		$this->stm_ew_add_color(
			'email_btn_bg_color',
			array(
				'label'     => __( 'Email Button Background Color', 'stm-elementor-widgets' ),
				'selectors' => array(
		...
		$this->stm_ew_add_color(
			...
			array(
				'label'     => __( 'Email Button Text Color', 'stm-elementor-widgets' ),
				'selectors' => array(
		...
		$this->stm_ew_add_color(
			'phone_btn_bg_color',
			array(
				'label'     => __( 'Phone Button Background Color', 'stm-elementor-widgets' ),
				'selectors' => array(
		...
		$this->stm_ew_add_color(
			...
			array(
				'label'     => __( 'Phone Button Text Color', 'stm-elementor-widgets' ),
				'selectors' => array(
		...
		$this->stm_ew_add_color(
			'phone_icon_color',
			array(
				'label'     => __( 'Phone Icon Color', 'stm-elementor-widgets' ),
				'selectors' => array(
	...
	protected function render() {
		...
		Helper::stm_ew_load_template( 'widgets/team-member', STM_ELEMENTOR_WIDGETS_PATH, $settings );
	}

...
if (!class_exists('ButterBeanCarRental')) {
    /**
     ...
     * @access public
     */
    final class ButterBeanCarRental
    {
        ...
        private function includes()
        {
            ...
            require_once($this->dir_path . 'inc/controls/class-control-car-rental-datepicker.php');
        ...
        private function setup_actions()
        {
            ...
            add_action('butterbean_car_rental_register', array($this, 'register_manager_types'), -95);
            add_action('butterbean_car_rental_register', array($this, 'register_section_types'), -95);
            add_action('butterbean_car_rental_register', array($this, 'register_control_types'), -95);
            add_action('butterbean_car_rental_register', array($this, 'register_setting_types'), -95);
        }

        /**
         * Registration callback. Fires the `butterbean_car_rental_register` action hook to
        ...
        public function register()
        {
            ...
            do_action('butterbean_car_rental_register', $this, $post_type);
        ...
        public function register_manager_types()
        {
            ...
            $this->register_manager_type('default', 'ButterBean_CarRental_Manager');
        }
        ...
        public function register_section_types()
        {
            ...
            $this->register_section_type('default', 'ButterBean_CarRental_Section');
        }
        ...
        public function register_control_types()
        {
            ...
            $this->register_control_type('default', 'ButterBean_CarRental_Control');
            $this->register_control_type('checkboxes', 'ButterBean_CarRental_Control_Checkboxes');
            $this->register_control_type('color', 'ButterBean_CarRental_Control_Color');
            $this->register_control_type('datetime', 'ButterBean_CarRental_Control_Datetime');
            $this->register_control_type('excerpt', 'ButterBean_CarRental_Control_Excerpt');
            $this->register_control_type('image', 'ButterBean_CarRental_Control_Image');
            $this->register_control_type('palette', 'ButterBean_CarRental_Control_Palette');
            $this->register_control_type('radio', 'ButterBean_CarRental_Control_Radio');
            $this->register_control_type('radio-image', 'ButterBean_CarRental_Control_Radio_Image');
            $this->register_control_type('select-group', 'ButterBean_CarRental_Control_Select_Group');
            $this->register_control_type('textarea', 'ButterBean_CarRental_Control_Textarea');
            $this->register_control_type('multi-avatars', 'ButterBean_CarRental_Control_Multi_Avatars');
            $this->register_control_type('parent', 'ButterBean_CarRental_Control_Parent');
            $this->register_control_type('gallery', 'ButterBean_CarRental_Control_Gallery');
            $this->register_control_type('car_rental-datepicker', 'ButterBean_CarRental_Control_CarRental_Datepicker');
			$this->register_control_type('timepicker', 'ButterBean_CarRental_Control_Timepicker');
            $this->register_control_type('file', 'ButterBean_CarRental_Control_File');
            $this->register_control_type('repeater', 'ButterBean_CarRental_Control_Repeater');
            $this->register_control_type('checkbox_repeater', 'ButterBean_CarRental_Control_Checkbox_Repeater');
            $this->register_control_type('multiselect', 'ButterBean_CarRental_Control_Multiselect');
        }
        ...
        public function register_setting_types()
        {
            ...
            $this->register_setting_type('default', 'ButterBean_CarRental_Setting');
            $this->register_setting_type('single', 'ButterBean_CarRental_Setting');
            $this->register_setting_type('multiple', 'ButterBean_CarRental_Setting_Multiple');
            $this->register_setting_type('array', 'ButterBean_CarRental_Setting_Array');
            $this->register_setting_type('datetime', 'ButterBean_CarRental_Setting_Datetime');
        }
        ...
        public function enqueue()
        {
            ...
            wp_enqueue_script('stm-car-rental-butterbean', $this->dir_uri . "js/stm_car_rental_butterbean_fields.js", array('butterbean'), '', true);

            // Enqueue the main plugin style.
            wp_enqueue_style('butterbean', $this->dir_uri . "css/butterbean{$min}.css");

            wp_enqueue_style('stm-car-rental-butterbean', $this->dir_uri . "css/stm_car_rental_butterbean.css");
        ...
        public function print_templates()
        {
            ...
            <script type="text/html" id="tmpl-butterbean-nav">
                <?php butterbean_car_rental_get_nav_template(); ?>
            </script>
     ...
     * @return object
     */
    function butterbeanCarRental()
    {
        return ButterBeanCarRental::get_instance();
    }

 ...
 * @access public
 */
class ButterBean_CarRental_Manager {
	...
	public function register_section( $section, $args = array() ) {
		...
		if ( ! is_object( $section ) ) {
			...
			$type = isset( $args['type'] ) ? butterbeanCarRental()->get_section_type( $args['type'] ) : butterbeanCarRental()->get_section_type( 'default' );
	...
	public function register_control( $control, $args = array() ) {
		...
		if ( ! is_object( $control ) ) {
			...
			$type = isset( $args['type'] ) ? butterbeanCarRental()->get_control_type( $args['type'] ) : butterbeanCarRental()->get_control_type( 'default' );
	...
	public function register_setting( $setting, $args = array() ) {
		...
		if ( ! is_object( $setting ) ) {
			...
			$type = isset( $args['type'] ) ? butterbeanCarRental()->get_setting_type( $args['type'] ) : butterbeanCarRental()->get_setting_type( 'default' );
	...
	public function get_template() {
		butterbean_car_rental_get_manager_template( $this->type );
	}
}

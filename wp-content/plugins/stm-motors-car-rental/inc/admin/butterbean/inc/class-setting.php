 ...
 * @access public
 */
class ButterBean_CarRental_Setting {
	...
	public function get_value() {
		...
		return ! $value && butterbeanCarRental()->is_new_post ? $this->default : $value;
	}
	...
	public function save() {
		...
		//if($this->name=)
		echo $this->name;
		//print_r($_POST['butterbean_stm_car_rent_info_setting_stm_rental_office']);

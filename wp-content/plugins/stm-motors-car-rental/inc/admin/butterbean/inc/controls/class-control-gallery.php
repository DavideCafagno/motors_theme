 ...
 * @access public
 */
class ButterBean_CarRental_Control_Gallery extends ButterBean_CarRental_Control {
    ...
    public function __construct( $manager, $name, $args = array() ) {
        ...
        $this->l10n = wp_parse_args(
            ...
            array(
                ...
                'set' => esc_html__('Add images', 'stm_motors_car_rental'),
                'choose' => esc_html__('Choose images', 'stm_motors_car_rental'),
                'change' => esc_html__('Add images', 'stm_motors_car_rental'),
                'remove' => esc_html__('Remove all', 'stm_motors_car_rental'),
                'drop' => esc_html__('Drag and drop featured image here', 'stm_motors_car_rental'),
                'placeholder' => esc_html__('No images selected', 'stm_motors_car_rental')
            )
        );
    }

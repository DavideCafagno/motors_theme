...
( function() {
    ...
    /*Datepicker*/
    butterbean.views.register_control( 'car-rental-datepicker', {
        events : {
            'click .butterbean-car-rental-datepicker': 'initDatepicker',
        },

        ready: function(){
            jQuery( '.butterbean-car-rental-datepicker' ).datepicker({
                dateFormat: "dd-mm-yy"
            });
        },

(function($) {
    $(document).ready(function () {
        ...
        $(document).on('click', '.stm_vehicles_listing_icon .stm_delete_icon', function(e){
            $(this).closest('.stm_form_wrapper_icon').find('input[name="stm_taxonomy_c_six_icon"]').val('');
        ...
        $(document).on('click', '.stm_vehicles_listing_icon', function(e){
            ...
            console.log(currentTarget.find('input[name="stm_taxonomy_c_six_icon"]').val());

            var currentVal = '.' + currentTarget.find('input[name="stm_taxonomy_c_six_icon"]').val().replace(' ', '.');
            if(currentVal === '.') {
                return;
            }
        ...
        $('.stm_vehicles_listing_icons .inner td.stm-listings-pick-icon i').on('click', function(){
            ...
            currentTarget.find('input[name="stm_taxonomy_c_six_icon"]').val(stmClass);
